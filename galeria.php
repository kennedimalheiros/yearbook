...
try{
	...
	$conexao = conn_mysql();
	 ...
	 <form role="form" method="post" action="./galeriaBD.php" class="form-signin" enctype="multipart/form-data">

		  <div class="form-group">     
               <label for="fileName">Escolha sua foto: </label>
...
try{
	...
	$conexao = conn_mysql();		
		...
		// instrução SQL básica (sem restrição de nome)
		$SQLSelect = 'SELECT * FROM galeria where login = ?';
		...
		if (count($resultados)>0){
			echo "<div class=\"row\">";
				...
				echo "<div class=\"col-lg-6 col-md-6 col-xs-6 thumbnail\">";
				echo 	"<figure>";
