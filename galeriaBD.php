...
try
{
	...
	//se existem os parâmetros...
		...
		$SQLInsert = 'INSERT INTO galeria (login, arquivoFoto) 
			  		  VALUES (?,?)';
	   ...
	   //executa a sentença SQL com os parâmetros passados por um vetor
		$inserir = $operacao->execute(array( $login,$pathCompleto));
		...
		if ($inserir){
			 echo "<h1>Foto enviada com sucesso.</h1>\n";
			 echo "<p class=\"lead\"><a href=\"./galeria.php\">Voltar</a></p>\n";
		}
		else {
